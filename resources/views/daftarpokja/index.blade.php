...
<div class="row">
    ...
    <a href="{{route('daftarpokja.create')}}" class="d-none d-sm-inline-block btn btn-primary btn-sm shadow-sm"><i class="fa fa-plus-circle fa-fw fa-sm text-white-50"></i>Tambah Pegawai</a>
    </div> 
</div><br>
