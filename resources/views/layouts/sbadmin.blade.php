...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('dashboard.dash')}}">
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('daftarpokja.index')}}">Master Data Pegawai</a>
          </div>
        </div>
      </li>
      @endif
      ...
      <li class="nav-item">
        ...
        <div id="collapse3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Input Data :</h6>
            <a class="collapse-item" href="{{route('datapenyedia.index')}}">Verifikasi Penyedia Baru</a>
            <a class="collapse-item" href="{{route('rubahpenyedia.index')}}">Perubahan Data Penyedia</a>
          </div>
        </div>
      </li>
      <!-- Heading -->
      ...
      <li class="nav-item">
        ...
        <div id="laporan" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item" href="{{route('laporanulp.hasillelang')}}">Hasil Lelang</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="laporanlpse" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Laporan :</h6>
            <a class="collapse-item" href="{{route('laporanlpse.penyediabaru')}}">Penyedia Baru</a>
            <a class="collapse-item" href="{{route('laporanlpse.perubahanpenyedia')}}">Pergantian Data Penyedia</a>
          </div>
        </div>
      </li>
      <!-- Nav Item - Tables -->
